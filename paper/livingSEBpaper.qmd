...
To be included in the quantitative synthesis, studies also had to:
...
As exemplified in these analyses, the *Living SEB Project* provides the necessary tools for responding cross-sectional research questions and synthesizing the available evidence using meta-analysis. However, different uses can be made of this data and of the *Living SEB App*.
