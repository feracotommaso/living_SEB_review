...
To test the bivariate associations between the five SEB skill domains and academic achievement, we use a three-level random-effects model, with effects nested within samples and studies. In line with Borenstein and colleagues [-@borenstein2021], Fisher’s *z* transformations were applied and then back-transformed to Pearson’s *r* for interpretation. The metafor package was used for the meta-analysis [@viechtbauer2010ConductingMetaanalysesMetafor].
...
The metaSEM [@cheung2024MetaSEMMetaAnalysisUsing] and lavaan [@rosseel2012LavaanPackageStructural] R packages were used for these analysis.
